    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.conteudoCard}>
          <Text style={styles.tituloCard}>Cadastrar novo alimento</Text>
      ...
      <Pressable style={styles.botaoHistorico} onPress={handleHistorico}>
        <Text style={styles.iconeHistorico}>↻</Text>
